...
var CommonFlags = []cli.Flag{
	...
	&cli.StringFlag{
		Name:    "exec",
		Usage:   "Shell command to execute on each incoming webhook event. The JSON payload is available via $GOHOOKBRIDGE_PAYLOAD_FILE and headers via $GOHOOKBRIDGE_HEADERS_FILE (temporary files, cleaned up after execution). Security warning: do not use this with untrusted webhook sources without proper input validation",
		EnvVars: []string{"GOHOOKBRIDGE_EXEC"},
	},
	&cli.StringSliceFlag{
		Name:    "exec-on-events",
		Aliases: []string{"E"},
	...
	&cli.StringSliceFlag{
		...
		EnvVars: []string{"GOHOOKBRIDGE_EXEC_ENV_VARS"},
	},
}
...
var KeygenFlags = []cli.Flag{
	&cli.StringFlag{
		...
		Required: true,
		EnvVars:  []string{"GOHOOKBRIDGE_ENCRYPTION_KEY_FILE"},
	},
}
...
var ClientFlags = []cli.Flag{
	...
	&cli.IntFlag{
		...
		Value:   0,
		EnvVars: []string{"GOHOOKBRIDGE_HEALTH_PORT"},
	},
	&cli.IntFlag{
		Name:    "sse-buffer-size",
		Usage:   "SSE client buffer size in bytes",
		Value:   1048576, // 1MB
		EnvVars: []string{"GOHOOKBRIDGE_SSE_BUFFER_SIZE"},
	},
	&cli.StringFlag{
	...
	&cli.StringFlag{
		...
		EnvVars: []string{"GOHOOKBRIDGE_ENCRYPTION_KEY"},
	},
	&cli.BoolFlag{
		Name:    "resume",
		Aliases: []string{"r"},
	...
	&cli.StringFlag{
		...
		EnvVars: []string{"GOHOOKBRIDGE_CLIENT_ID"},
	},
	&cli.StringFlag{
		Name:    "token",
		Usage:   "Access token for channel authentication",
		EnvVars: []string{"GOHOOKBRIDGE_TOKEN"},
	},
}
...
var ProduceFlags = []cli.Flag{
	&cli.StringFlag{
		...
		EnvVars: []string{"GOHOOKBRIDGE_ENCRYPTION_PUBLIC_KEY"},
	},
	&cli.StringFlag{
		Name:    "pubkey-file",
...
var ServerFlags = []cli.Flag{
	...
	&cli.StringFlag{
		...
		EnvVars: []string{"GOHOOKBRIDGE_TLS_CERT"},
	},
	&cli.StringFlag{
		Name:    "tls-key",
		Usage:   "TLS key file",
		EnvVars: []string{"GOHOOKBRIDGE_TLS_KEY"},
	},
	&cli.StringFlag{
		Name:    "raft-dir",
		Usage:   "Raft data directory (BoltDB stores)",
		Value:   "./raft-data",
		EnvVars: []string{"GOHOOKBRIDGE_RAFT_DIR"},
	},
	&cli.StringFlag{
		Name:    "raft-node-id",
		Usage:   "Unique Raft node ID",
		Value:   "node1",
		EnvVars: []string{"GOHOOKBRIDGE_RAFT_NODE_ID"},
	},
	&cli.StringFlag{
		Name:    "raft-bind-addr",
		Usage:   "Raft TCP bind address for inter-node communication",
		Value:   "127.0.0.1:6001",
		EnvVars: []string{"GOHOOKBRIDGE_RAFT_BIND_ADDR"},
	},
	&cli.StringSliceFlag{
		Name:    "raft-peers",
		...
		EnvVars: []string{"GOHOOKBRIDGE_RAFT_PEERS"},
	},
	&cli.StringFlag{
	...
	&cli.BoolFlag{
		...
		EnvVars: []string{"GOHOOKBRIDGE_RAFT_RECOVERY_MODE"},
	},
	&cli.BoolFlag{
